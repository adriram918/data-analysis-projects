...
while number_astronauts <= 7:
    number_astronauts = int(input('enter the number of astronauts: '))
  
    
# c. Use a final loop to monitor the fuel status and the altitude of the shuttle. Each iteration, decrease the fuel level by 100 units for each astronaut aboard. Also, increase the altitude by 50 kilometers.
while fuel_level-100*number_astronauts >= 0:
    altitude += 50
    fuel_level -= 100*number_astronauts
...
if altitude >= 2000:
    ...
    print("The shuttle gained an altitud of" + altitude + "km and has" + fuel_level + "kg of fuel left")
